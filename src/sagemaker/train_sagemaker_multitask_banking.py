# ============================================================
# MULTI-TASK INDUSTRY-CONDITIONED TRAINING SCRIPT
# File: train_sagemaker_multitask_banking.py
# ============================================================
...
# CONFIG (UNCHANGED)
# -------------------------
MODEL_NAME = "xlm-roberta-base"   # 🔒 locked encoder
MAX_LEN = 160
...
class MultiTaskDataset(Dataset):
    def __init__(self, df):
        # 🔥 INDUSTRY-CONDITIONED INPUT (Banking)
        # Industry is constant = "banking", but kept for forward compatibility
        self.texts = [
            f"banking : {txt}"
            for txt in df["text"]
        ]
...
# -------------------------
# SAVE MODEL (BANKING – PRODUCTION SAFE)
# -------------------------
# 1️⃣ Save encoder
...
# 3️⃣ Save multitask weights (BANKING)
torch.save(
    model.state_dict(),
    os.path.join(model_dir, "cx_multitask_banking_v1.pt")
)

print("✅ BANKING MULTI-TASK MODEL SAVED SUCCESSFULLY")