# ============================================================
# FILE 2 : run_training_phase4.py
# PURPOSE: SageMaker Launcher — Phase-4 Aspect Sentiment
# ============================================================
...
estimator = PyTorch(
    entry_point="train_sagemaker_phase4.py",
...
print("\n🚀 Launching Phase-4 Aspect-Sentiment Training...\n")
