...
# ============================================================
# FILE    : banking_priority_engine_v2.py
# PURPOSE : Banking Priority Gold Label Generator
#
# INPUT   : text, sentiment, primary_aspect, emotion
# OUTPUT  : + priority
#
# PRIORITY LABELS:
#   0 = LOW
...
INPUT_PATH  = r"D:/bert_data/logistics data/train+intent+aspects_v4+emotion.csv"
OUTPUT_PATH = r"D:/bert_data/logistics data/train+intent+aspects_v4+emotion+priority.csv"
...
def assign_priority(sentiment, aspect, emotion):
    """
    sentiment:
        0 = Negative
        1 = Neutral
    ...
    # Angry + financial issue
    if emotion == 0 and aspect in CRITICAL_ASPECTS:
        return 3

    # Strong negative financial complaint
    if sentiment == 0 and aspect in CRITICAL_ASPECTS:
        return 3
    ...
    # Frustrated + operational banking issue
    if emotion == 1 and aspect in (CRITICAL_ASPECTS | OPERATIONAL_ASPECTS):
        return 2
...
required_cols = ["sentiment", "primary_aspect", "emotion"]
